...
Distribution_list = ['0.0', '0.33', '0.5', '0.66', '0.6']
...
with open(cases_run_path_and_name, "w") as f_w_cases_run:
    ...
    for Distribution in Distribution_list:
        ...
        for confining_stress in confining_stress_list:
            ...
            #creat new folder
            new_folder_name = 'Triaxial_D' + Distribution + '_P' + str(confining_stress)
            ...
            for seed_file_name in seed_file_name_list:
                ...
                if seed_file_name == 'MaterialsDEM.json':
                    ...
                    special_file_name = 'G-Triaxial-D-' + Distribution + '.mdpa'
                    special_file_path_and_name = os.path.join(os.getcwd(),'G-Triaxial-VaryD',special_file_name)
